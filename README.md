...
| broadcast-rcon-to-ops  | BROADCAST_RCON_TO_OPS  | true, false                               | true             | Broadcasts RCON output to the OPs on the server |
...
| enable-rcon            | ENABLE_RCON            | true, false                               | false            | Enable remote control of the server |
...
| rcon.password          | RCON_PASSWORD          | (any string)                              | (empty)          | Defines the password for the RCON feature |
| rcon.port              | RCON_PORT              | (any number)                              | 25575            | Defines the port for the RCON feature. |
